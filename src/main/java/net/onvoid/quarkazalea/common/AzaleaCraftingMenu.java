...
public class AzaleaCraftingMenu extends CraftingMenu {

    private final ContainerLevelAccess access;
    private final Block containerBlock;

    public AzaleaCraftingMenu(int p_39356_, Inventory p_39357_, ContainerLevelAccess p_39358_, Block containerBlock) {
