...
public static final BlockSubRegistryHelper HELPER = QuarkAzalea.REGISTRY_HELPER.getBlockSubHelper();
    ...
    public static final RegistryObject<Block> AZALEA_CABINET = HELPER.createCompatFuelBlock(FARMERS_DELIGHT_MODID, "azalea_cabinet", BlockSubRegistryHelper.areModsLoaded(FARMERS_DELIGHT_MODID) ? FarmersDelightCompat.AZALEA_CABINET : () -> new NotFoundBlock(BlockBehaviour.Properties.copy(Blocks.BARREL), "Farmer's Delight"), 300, CreativeModeTab.TAB_DECORATIONS);
    ...
    public static final RegistryObject<Block> FLOWERING_AZALEA_CABINET = HELPER.createCompatFuelBlock(FARMERS_DELIGHT_MODID, "flowering_azalea_cabinet", BlockSubRegistryHelper.areModsLoaded(FARMERS_DELIGHT_MODID) ? FarmersDelightCompat.FLOWERING_AZALEA_CABINET : () -> new NotFoundBlock(BlockBehaviour.Properties.copy(Blocks.BARREL), "Farmer's Delight"), 300, CreativeModeTab.TAB_DECORATIONS);
    ...
    public static final RegistryObject<Block> BLOSSOM_CABINET = HELPER.createCompatFuelBlock(FARMERS_DELIGHT_MODID, "blossom_cabinet", BlockSubRegistryHelper.areModsLoaded(FARMERS_DELIGHT_MODID) ? FarmersDelightCompat.BLOSSOM_CABINET : () -> new NotFoundBlock(BlockBehaviour.Properties.copy(Blocks.BARREL), "Farmer's Delight"), 300, CreativeModeTab.TAB_DECORATIONS);
